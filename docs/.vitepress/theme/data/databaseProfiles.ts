...
export const databaseProfiles: Record<string, DatabaseProfileData> = {
  ...
  scylladb: nosql('scylladb', 'ScyllaDB', '宽列数据库 · Cassandra 兼容', 'AGPL / Source Available / Commercial', '以 C++ shard-per-core 架构提供 Cassandra 兼容的高吞吐低尾延迟。', 'CQL 与 Alternator 键值 API。', ['高吞吐 Cassandra 工作负载', '低尾延迟事件存储', '减少节点数量的场景'], ['兼容性需按驱动和功能验证', '容量与 shard 调优复杂', '部分高级能力依商业版本']),

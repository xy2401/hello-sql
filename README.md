...
- **三大分卷，22 个数据库**：SQL（MySQL、PostgreSQL、Oracle、SQL Server、MariaDB、SQLite）、分析型（DuckDB、ClickHouse、TiDB、CockroachDB）、NoSQL 与浏览器数据库（MongoDB、Redis、Elasticsearch、Cassandra、Neo4j、Browser Database 等 12 个）。只收录可自托管、嵌入式或浏览器本地运行的产品。
